...
class newVersionDialog(wx.Dialog):
	def __init__(self):
		...
		s.Add(wx.StaticText(p, -1, 'Bienvenido'))
		s.Add(wx.StaticText(p, -1, '(Este mensaje solo se mostrara una vez)'))
		s.Add(wx.StaticLine(p), flag=wx.EXPAND|wx.TOP|wx.BOTTOM, border=10)
		s.Add(wx.StaticText(p, -1, 'Novedades 15.05.02.Moebyus:'))
		s.Add(wx.StaticText(p, -1, '* Completado el soporte de las maquinas de Moebyus'))
		s.Add(wx.StaticText(p, -1, '* Traduccion completa'))
		s.Add(wx.StaticText(p, -1, '* Ajustes en el interfaz grafico'))
		s.Add(wx.StaticText(p, -1, '* Perfiles QuickPrint para todas las maquinas'))
		s.Add(wx.StaticText(p, -1, '* Cargador de firmware para la mayoria de configuraciones de Prusa'))
